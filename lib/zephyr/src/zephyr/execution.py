...
class ZephyrCoordinator:
    ...
    def _emit_stage_stat(self, *, failed: bool = False) -> None:
        ...
        with self._lock:
            ...
            completed = [s.counters for s in self._completed_counters]
            inflight = [s.counters for s in self._worker_counters.values()]
        ...
        self._stats_writer.emit_stage_stat(stage_name, execution_id, elapsed, total, completed, inflight, status=status)
